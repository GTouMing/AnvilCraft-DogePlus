...
import dev.anvilcraft.gtouming.doge_plus.client.renderer.NodeSupportEntityRenderer;
import dev.anvilcraft.gtouming.doge_plus.event.NodeCaptureHandler;
...
public class AnvilCraftDogePlus {
    ...
    public AnvilCraftDogePlus(IEventBus modEventBus, ModContainer modContainer) {
        ...
        Mixins.addConfiguration("anvilcraft_doge_plus.mixins.json");
